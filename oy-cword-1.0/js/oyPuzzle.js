...
oyCrosswordPuzzle.prototype.init = function(){ 
	...
	//This contains the exit icon in the top right
	target.innerHTML = trackAction + '<a id="oygHeaderMenuBtn" href=""><img id="leaveGame" style="padding: 4px;" src="' + this.appHome + '/img/KIROlogo.jpg" border="0" alt="Leave Game"></a>';
